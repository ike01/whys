...
//    for (double t = start; t < .95; t += 0.001) {
    ...
    for (AlignTrainTest alignTrainTest : allTestcaseData) {
//      System.out.println(alignTrainTest.sourceOnto);
//      System.out.println(alignTrainTest.targetOnto);
      URI onto1 = alignTrainTest.sourceOnto.toPath().toUri();
      URI onto2 = alignTrainTest.targetOnto.toPath().toUri();
...
//    System.out.println(expected);
  ...
  public static List<AlignedConcept> domainWordEmb() throws AlignmentException {
    List<AlignedConcept> alignments = new ArrayList<>();
    System.out.println("\n===DomainWordEmb===");
    List<AlignTrainTest> allTestcaseData = Alignment_oaei.generateBencAlignTrainTest();
