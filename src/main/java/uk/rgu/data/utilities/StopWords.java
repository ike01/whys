...
/**
 * Implementation of reusable stop words.
 *
 * @author 1113938
 */
public class StopWords {

  // MySQL-specific list of stop words + a, he'll and she'll added
  private static final String[] mySQL = {"a","a's","able","about","above","according","accordingly","across",
    ...
    "doing","don't","done","down","downwards","during","each","edu","eg","eight",
    ...
    "it's","its","itself","just","keep","keeps","kept","know","known","knows","last",
    ...
    "much","must","my","myself","name","namely","nd","near","nearly","necessary",
    ...
    "relatively","respectively","right","said","same","saw","say","saying","says",
    ...
    "yourselves","zero","she'll","he'll"};

  public static List<String> MYSQL_STOP_WORDS = new ArrayList(Arrays.asList(mySQL));

  /**
   * Customised stopword list. MySQL stopword list with supplied strings included.
   *
   * @param addedStrings
   * @return
   */
  public static List<String> getCustomList(List<String> addedStrings) {
    List<String> newList = MYSQL_STOP_WORDS;
